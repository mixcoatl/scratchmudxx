...
public:
    ...
    String GetModulePath(const String& moduleName) const;
    ...
    LuaResult Require(const String& moduleName);
    ...
    //! Registers a const Game method with optional trailing arguments.
    //! \param name the Lua function name
    //! \param function the const Game method
    //! \param optional the optional argument markers
    template<typename ReturnT, typename... ArgsT,
    ...
    //! Registers a Lua method as a Lua free function.
    //! \param name the Lua function name
    ...
    //! Registers a Lua method with optional trailing arguments.
    //! \param name the Lua function name
    //! \param function the Lua method
    //! \param optional the optional argument markers
    template<typename ReturnT, typename... ArgsT,
    ...
    //! Registers a const Lua method as a Lua free function.
    //! \param name the Lua function name
    //! \param function the const Lua method
    template<typename ReturnT, typename... ArgsT>
    void Function(
	    const char* name,
	    ReturnT (Lua::*function)(ArgsT...) const);

    //! Registers a const Lua method with optional trailing arguments.
    //! \param name the Lua function name
    //! \param function the const Lua method
    //! \param optional the optional argument markers
    template<typename ReturnT, typename... ArgsT,
