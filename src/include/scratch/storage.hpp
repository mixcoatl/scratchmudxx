...
public:
    ...
    //! \sa Repository::IsValidThingId(const String&) const
    virtual bool IsValidThingId(const String& thingId) const noexcept {
	return !thingId.empty() &&
	    !Strings::CompareCi(Strings::SanitizeCopy(thingId), thingId);
    }
