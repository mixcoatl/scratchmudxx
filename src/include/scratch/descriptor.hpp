...
public:
    ...
    //! Gets the sector being edited.
    //! \sa #SetEditSector(const SectorPtr&)
    SectorPtr GetEditSector() const noexcept {
	return editSector_;
    }
    ...
    //! Sets the sector being edited.
    //! \param editSector the sector draft being edited
    //! \sa #GetEditSector() const
    SectorPtr SetEditSector(
	const SectorPtr& editSector = nullptr);
...
protected:
    ...
    //! The sector being edited.
    //! \sa #GetEditSector() const
    //! \sa #SetEditSector(const SectorPtr&)
    SectorPtr editSector_;
