...
public:
    ...
    DataPtr Get(
	const String& key,
	const DataPtr& defaultValue = nullptr) noexcept;
    ...
    StringMapCi<String> GetStringMap(
	const String& key,
	const StringMapCi<String>& defaultValue = StringMapCi<String>()) noexcept;
    ...
    StringSetCi GetStringSet(
	const String& key,
	const StringSetCi& defaultValue = StringSetCi()) noexcept;
