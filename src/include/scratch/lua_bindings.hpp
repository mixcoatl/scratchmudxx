...
class LuaResult {
public:
    //! The stack emitter function type.
    using Emitter = std::function<int(lua_State*)>;

    //! Constructs deferred result.
    //! \param emit the stack emitter
    explicit LuaResult(Emitter emit) :
	emit_(std::move(emit)) {
    }

    //! Emits the deferred result.
    //! \param L the \c lua_State
    //! \return the number of Lua results
    int Emit(lua_State* L) const {
	return emit_(L);
    }
...
//! Invokes a typed Game member function.
template<typename SignatureT>
struct GameMemberInvoker;

//! Invokes a typed Lua member function.
template<typename SignatureT>
struct LuaMemberInvoker;

//! Invokes a typed Game member function with optional trailing arguments.
template<std::size_t OptionalCount, typename SignatureT>
struct OptionalGameMemberInvoker;

//! Invokes a typed Lua member function with optional trailing arguments.
template<std::size_t OptionalCount, typename SignatureT>
struct OptionalLuaMemberInvoker;
...
template<std::size_t OptionalCount, typename ReturnT, typename... ArgsT>
struct OptionalGameMemberInvoker<
	OptionalCount, ReturnT (Game::*)(ArgsT...) const> {
...
//! Invokes a Lua method that returns a deferred Lua result.
//! \param L the \c lua_State
//! \param owner the Lua facade
//! \param method the member function
//! \param arguments the bound arguments
//! \return the number of Lua results
template<typename Arguments, typename MethodT, typename OwnerT,
    std::size_t... Index>
inline int InvokeLuaResult(
	lua_State* L,
	OwnerT& owner,
	MethodT method,
	Arguments& arguments,
	...
	[&]() {
	    return (owner.*method)(
		std::get<Index>(arguments).Get()...).Emit(L);
	},
	std::false_type());
}

template<typename... ArgsT>
struct LuaMemberInvoker<LuaResult (Lua::*)(ArgsT...)> {
    using Arguments = LuaArguments<ArgsT...>;
	...
	if (lua_gettop(L) != expected)
	    return luaL_error(L, "invalid argument count");
	auto arguments = Arguments::ReadRoot(L);
	auto& lua = Lua::CheckLua(L);
	auto method = *static_cast<LuaResult (Lua::**)(ArgsT...)>(
	    lua_touserdata(L, lua_upvalueindex(1)));
	return InvokeLuaResult(
	    L, lua, method, arguments,
	    std::index_sequence_for<ArgsT...>());
    }
};

template<typename... ArgsT>
struct LuaMemberInvoker<LuaResult (Lua::*)(ArgsT...) const> {
    using Arguments = LuaArguments<ArgsT...>;
	...
	if (lua_gettop(L) != expected)
	    return luaL_error(L, "invalid argument count");
	auto arguments = Arguments::ReadRoot(L);
	const auto& lua = Lua::CheckLua(L);
	auto method = *static_cast<LuaResult (Lua::**)(ArgsT...) const>(
	    lua_touserdata(L, lua_upvalueindex(1)));
	return InvokeLuaResult(
	    L, lua, method, arguments,
	    std::index_sequence_for<ArgsT...>());
...
template<typename ReturnT, typename... ArgsT>
struct LuaMemberInvoker<ReturnT (Lua::*)(ArgsT...)> {
    static int Call(lua_State* L) {
	const int expected = static_cast<int>(sizeof...(ArgsT));
	if (lua_gettop(L) != expected)
	    return luaL_error(L, "invalid argument count");
	auto arguments = LuaArguments<ArgsT...>::ReadRoot(L);
	return Invoke(L, Lua::CheckLua(L), arguments,
	    std::index_sequence_for<ArgsT...>());
    }
    ...
    static int Invoke(
	    ...
	    typename LuaArguments<ArgsT...>::Values& arguments,
	    std::index_sequence<Index...>) {
	return InvokeResult(L, lua, arguments,
	    std::index_sequence<Index...>(),
	    typename std::is_void<ReturnT>::type());
    }
	...
	auto method = *static_cast<
	    ReturnT (Lua::**)(ArgsT...)>(
	    lua_touserdata(L, lua_upvalueindex(1)));
	(lua.*method)(std::get<Index>(arguments).Get()...);
	return 0;
    }
...
template<typename ReturnT, typename... ArgsT>
struct LuaMemberInvoker<ReturnT (Lua::*)(ArgsT...) const> {
    static int Call(lua_State* L) {
	const int expected = static_cast<int>(sizeof...(ArgsT));
	if (lua_gettop(L) != expected)
	    return luaL_error(L, "invalid argument count");
...
template<std::size_t OptionalCount, typename ReturnT, typename... ArgsT>
struct OptionalLuaMemberInvoker<
	OptionalCount, ReturnT (Lua::*)(ArgsT...)> {
    using SignatureT = ReturnT (Lua::*)(ArgsT...);
    using Arguments = LuaArguments<ArgsT...>;
	...
	auto arguments = Arguments::template ReadOptionalRoot<OptionalCount>(
	    L, method->defaults);
	return Invoke(
	    L, Lua::CheckLua(L), arguments, method->function,
	    std::index_sequence_for<ArgsT...>());
    }
    ...
    static int Invoke(
	    ...
	    std::index_sequence<Index...>) {
	return InvokeResult(
	    L, lua, arguments, method, std::index_sequence<Index...>(),
	    typename std::is_void<ReturnT>::type());
    }
...
template<std::size_t OptionalCount, typename ReturnT, typename... ArgsT>
struct OptionalLuaMemberInvoker<
	OptionalCount, ReturnT (Lua::*)(ArgsT...) const> {
    using SignatureT = ReturnT (Lua::*)(ArgsT...) const;
    using Arguments = LuaArguments<ArgsT...>;
...
template<std::size_t OptionalCount, typename... ArgsT>
struct OptionalLuaMemberInvoker<
	OptionalCount, LuaResult (Lua::*)(ArgsT...)> {
    using SignatureT = LuaResult (Lua::*)(ArgsT...);
    using Arguments = LuaArguments<ArgsT...>;
	...
	auto& lua = Lua::CheckLua(L);
	return InvokeLuaResult(
	    L, lua, method->function, arguments,
	    std::index_sequence_for<ArgsT...>());
    }
};
...
template<std::size_t OptionalCount, typename... ArgsT>
struct OptionalLuaMemberInvoker<
	OptionalCount, LuaResult (Lua::*)(ArgsT...) const> {
    using SignatureT = LuaResult (Lua::*)(ArgsT...) const;
    using Arguments = LuaArguments<ArgsT...>;
...
template<typename ClassT, std::size_t OptionalCount, typename SignatureT>
struct OptionalInjectedMemberInvoker;
...
template<typename ClassT, typename ReturnT, typename... ArgsT>
struct InjectedMemberInvoker<
	ClassT, ReturnT (ClassT::*)(const Game&, ArgsT...) const noexcept> {
    using SignatureT =
	ReturnT (ClassT::*)(const Game&, ArgsT...) const noexcept;
    using Arguments = LuaArguments<ArgsT...>;
...
//! Invokes a typed free function returning a deferred Lua result.
template<std::size_t OptionalCount, typename... ArgsT>
struct FreeFunctionInvoker<
	LuaResult (*)(ArgsT...),
	OptionalCount> {
    ...
    static int Invoke(
	    ...
	    typename Arguments::Values& arguments,
	    std::index_sequence<Index...>) {
	using SignatureT = LuaResult (*)(ArgsT...);
	auto function = *static_cast<SignatureT*>(
	    lua_touserdata(L, lua_upvalueindex(1)));
	return SafeInvoke<false>(
	    L,
...
public:
    ...
    //! and optional trailing arguments.
    //! \param name the Lua function name
    //! \param method the member function
    //! \param injected the injected Game marker
    //! \param optional the optional argument markers
	...
	SetOptionalMethod(
	    name,
	    &Detail::OptionalInjectedMemberInvoker<
		ClassT,
		sizeof...(OptionalArgsT) + 1,
		ReturnT (ClassT::*)(const Game&, ArgsT...) const>::Call,
	    method,
    ...
    ClassBinding& Function(
	    const char* name,
	    ReturnT (ClassT::*method)(const Game&, ArgsT...) const noexcept,
	    Detail::InjectedArgument<Game> injected) {
	(void)injected;
	SetMethod(
	    name,
	    ...
	    &Detail::InjectedMemberInvoker<
		ClassT,
		ReturnT (ClassT::*)(const Game&, ArgsT...) const noexcept>::Call);
	return *this;
    }
...
void Lua::Function(
	const char* name,
	ReturnT (Lua::*function)(ArgsT...)) {
    auto* L = GetState();
    using SignatureT = ReturnT (Lua::*)(ArgsT...);
    auto* memory = lua_newuserdata(L, sizeof(SignatureT));
    new (memory) SignatureT(function);
    lua_pushcclosure(
	L, &Detail::LuaMemberInvoker<SignatureT>::Call, 1);
    SetSafeValue(name);
}
...
void Lua::Function(
    ...
    lua_pushcclosure(
	L,
	&Detail::OptionalLuaMemberInvoker<
	    sizeof...(OptionalArgsT) + 1, SignatureT>::Call,
	1);
    SetSafeValue(name);
}
...
void Lua::Function(
	const char* name,
	ReturnT (Lua::*function)(ArgsT...) const) {
    auto* L = GetState();
    using SignatureT = ReturnT (Lua::*)(ArgsT...) const;
    auto* memory = lua_newuserdata(L, sizeof(SignatureT));
    new (memory) SignatureT(function);
