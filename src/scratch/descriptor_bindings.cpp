...
void DescriptorBindings::Register(Lua& lua) {
	...
	Function("clear_edit_sector", &Descriptor::ClearEditSector).
	...
	Function("get_edit_sector", &Descriptor::GetEditSector).
	...
	Function("get_edit_zone", &Descriptor::GetEditZone).
	...
	Function("set_edit_sector", &Descriptor::SetEditSector).
