...
Color::ColorEnum Color::ByName(const String& name) noexcept {
	...
	colors["Cyan"] = C_TEAL;
	colors["Daytime"] = C_DAYTIME;
	colors["Description"] = C_DESCRIPTION;
	...
	colors["Movement"] = C_MOVEMENT;
	colors["Name"] = C_NAME;
	colors["Nighttime"] = C_NIGHTTIME;
	colors["Normal"] = C_NORMAL;
	colors["Notice"] = C_NOTICE;
...
String Color::ToString(ColorEnum value) noexcept {
    ...
    case C_TITLE:	return String("Title");
