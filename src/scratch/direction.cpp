...
//! Returns the phrase of \p value.
//! \param value the direction
//! \sa #ToString(DirectionEnum)
String Direction::ToPhrase(const DirectionEnum value) noexcept {
    static const String phrases[MAX_D_TYPES] = {
	"the east", "the southeast", "the south", "the southwest",
	"the west", "the northwest", "the north", "the northeast",
	"above", "below"
    };
    return IsDefined(value) ? phrases[value] : String();
}
